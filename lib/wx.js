(function (win, doc, wx, $) {
        ...
        getImage: function () {
            ...
            wx.chooseImage({
                ...
                success: function (res) {
                    ...
                    if (inst.options && typeof(inst.options.getImageComplete) == 'function') {
                        inst.options.getImageComplete(res.localIds.toString());
                    }
                    inst.uploadImage(res.localIds.toString());
                }
            });
        },
        /**
        ...
        uploadImage: function (localId) {
            ...
            wx.uploadImage({
                ...
                success: function (res) {
                    ...
                    if (inst.options && typeof(inst.options.uploadImageComplete) == 'function') {
                        inst.options.uploadImageComplete(res.serverId);
                    }
                }
            });
        },
    ...
    $.post('/patrol/wx/serve.xview?doType=111', {url:'http://2u4tqh.natappfree.cc/weixin/'}, function (data) {
        var jsAPIConfig=data.config;
        wx.config({
            ...
            signature: jsAPIConfig.sign,// 必填，签名，见附录1
